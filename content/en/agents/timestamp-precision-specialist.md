---
id: bwc-agent-timestamp-precision-specialist
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/timestamp-precision-specialist.md
name: timestamp-precision-specialist
category: specialized-domains
description: >-
  Extract frame-accurate timestamps from audio/video files for podcast editing.
  Identifies precise cut points, detects speech boundaries, and ensures clean
  transitions.
---
