---
id: bwc-agent-audio-quality-controller
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/audio-quality-controller.md
name: audio-quality-controller
category: specialized-domains
description: >-
  Analyzes, enhances, and standardizes audio quality for professional-grade
  content. Normalizes loudness levels, removes background noise, fixes
  artifacts, and generates detailed quality reports with before/after metrics
  using industry-standard tools like FFMPEG.
---
