---
id: bwc-agent-accessibility-specialist
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/accessibility-specialist.md
name: accessibility-specialist
description: >-
  Ensure web applications meet WCAG 2.1 AA/AAA standards. Implements ARIA
  attributes, keyboard navigation, and screen reader support. Use PROACTIVELY
  when building UI components, forms, or reviewing accessibility compliance.
