---
id: bwc-agent-prompt-engineer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/prompt-engineer.md
name: prompt-engineer
description: >-
  Optimizes prompts for LLMs and AI systems. Use when building AI features,
  improving agent performance, or crafting system prompts. Expert in prompt
