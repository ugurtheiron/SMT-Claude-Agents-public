---
id: bwc-agent-research-brief-generator
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/research-brief-generator.md
name: research-brief-generator
category: specialized-domains
description: >-
  Transforms user research queries into structured, actionable research briefs
  with specific questions, keywords, source preferences, and success criteria.
  Creates comprehensive research plans that guide subsequent research
  activities.
---
