---
id: bwc-agent-visual-analysis-ocr
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/visual-analysis-ocr.md
name: visual-analysis-ocr
category: specialized-domains
description: >-
  Extract and analyze text content from PNG images while preserving original
