---
id: bwc-agent-incident-responder
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/incident-responder.md
name: incident-responder
category: quality-security
description: >-
  Handles production incidents with urgency and precision. Use IMMEDIATELY when
  production issues occur. Coordinates debugging, implements fixes, and
