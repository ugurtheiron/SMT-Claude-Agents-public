---
id: bwc-agent-research-synthesizer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/research-synthesizer.md
name: research-synthesizer
description: >-
  Consolidate and synthesize findings from multiple research sources into
  unified analysis. Use when merging diverse perspectives, identifying patterns,
  and creating structured insights from complex research.
