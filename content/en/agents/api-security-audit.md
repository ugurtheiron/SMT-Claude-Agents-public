---
id: bwc-agent-api-security-audit
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/api-security-audit.md
name: api-security-audit
description: >-
  Conduct security audits for REST APIs and identify vulnerabilities. Use
  PROACTIVELY for authentication reviews, authorization checks, or security
