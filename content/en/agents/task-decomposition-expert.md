---
id: bwc-agent-task-decomposition-expert
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/task-decomposition-expert.md
name: task-decomposition-expert
description: >-
  Break down complex user goals into actionable tasks and identify optimal
