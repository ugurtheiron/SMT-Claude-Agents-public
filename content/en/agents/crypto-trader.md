---
id: bwc-agent-crypto-trader
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/crypto-trader.md
name: crypto-trader
description: >-
  Build cryptocurrency trading systems, implement trading strategies, and
  integrate with exchange APIs. Use PROACTIVELY for crypto trading bots, order
