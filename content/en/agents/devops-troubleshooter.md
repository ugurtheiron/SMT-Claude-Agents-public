---
id: bwc-agent-devops-troubleshooter
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/devops-troubleshooter.md
name: devops-troubleshooter
description: >-
  Debug production issues, analyze logs, and fix deployment failures. Masters
  monitoring tools, incident response, and root cause analysis. Use PROACTIVELY
  for production debugging or system outages.
