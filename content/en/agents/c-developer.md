---
id: bwc-agent-c-developer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/c-developer.md
name: c-developer
description: >-
  C programming expert for systems programming and embedded development. Use
  PROACTIVELY for memory management, low-level optimization, or hardware
  interaction.
