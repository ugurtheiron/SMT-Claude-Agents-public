---
id: bwc-agent-blockchain-developer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/blockchain-developer.md
name: blockchain-developer
description: >-
  Develop smart contracts, DeFi protocols, and Web3 applications. Expertise in
  Solidity, security auditing, and gas optimization. Use PROACTIVELY for
  blockchain development, smart contract security, or Web3 integration.
