---
id: bwc-agent-tag-agent
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/tag-agent.md
name: tag-agent
category: specialized-domains
description: >-
  Normalizes and hierarchically organizes tag taxonomy for knowledge management
  systems. Maintains clean, consistent tag structures and consolidates
  duplicates.
---
