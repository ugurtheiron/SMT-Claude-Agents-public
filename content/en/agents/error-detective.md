---
id: bwc-agent-error-detective
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/error-detective.md
name: error-detective
description: >-
  Search logs for error patterns and identify root causes. Use PROACTIVELY when
