---
id: bwc-agent-defi-strategist
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/defi-strategist.md
name: defi-strategist
description: >-
  Design and implement DeFi yield strategies, liquidity provision, and protocol
  interactions. Use PROACTIVELY for yield farming, liquidity mining, and DeFi
