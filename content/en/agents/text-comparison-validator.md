---
id: bwc-agent-text-comparison-validator
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/text-comparison-validator.md
name: text-comparison-validator
category: specialized-domains
description: >-
  Compare extracted text from images with existing markdown files to ensure
  accuracy and consistency. Detects discrepancies, errors, and formatting
  inconsistencies.
---
