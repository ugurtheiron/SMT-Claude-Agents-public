---
id: bwc-skill-google-calendar-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/google-calendar-automation/SKILL.md
name: google-calendar-automation
description: >-
  Automate Google Calendar events, scheduling, availability checks, and attendee
  management via Rube MCP (Composio). Create events, find free slots, manage
