---
id: bwc-skill-todoist-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/todoist-automation/SKILL.md
name: todoist-automation
description: >-
  Automate Todoist task management, projects, sections, filtering, and bulk
  operations via Rube MCP (Composio). Always search tools first for current
  schemas.
requires:
  mcp:
    - rube
