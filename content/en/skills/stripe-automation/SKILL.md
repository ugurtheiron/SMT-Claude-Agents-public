---
id: bwc-skill-stripe-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/stripe-automation/SKILL.md
name: stripe-automation
description: >-
  Automate Stripe tasks via Rube MCP (Composio): customers, charges,
