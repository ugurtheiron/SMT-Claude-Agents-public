---
id: bwc-skill-docusign-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/docusign-automation/SKILL.md
name: docusign-automation
description: >-
  Automate DocuSign tasks via Rube MCP (Composio): templates, envelopes,
  signatures, document management. Always search tools first for current
  schemas.
requires:
  mcp:
    - rube
