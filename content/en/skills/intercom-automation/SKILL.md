---
id: bwc-skill-intercom-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/intercom-automation/SKILL.md
name: intercom-automation
description: >-
  Automate Intercom tasks via Rube MCP (Composio): conversations, contacts,
