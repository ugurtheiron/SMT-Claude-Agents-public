---
id: bwc-skill-whatsapp-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/whatsapp-automation/SKILL.md
name: whatsapp-automation
description: >-
  Automate WhatsApp Business tasks via Rube MCP (Composio): send messages,
  manage templates, upload media, and handle contacts. Always search tools first
  for current schemas.
requires:
  mcp:
    - rube
