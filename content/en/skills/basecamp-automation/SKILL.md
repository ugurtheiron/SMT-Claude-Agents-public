---
id: bwc-skill-basecamp-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/basecamp-automation/SKILL.md
name: basecamp-automation
description: >-
  Automate Basecamp project management, to-dos, messages, people, and to-do list
  organization via Rube MCP (Composio). Always search tools first for current
  schemas.
requires:
  mcp:
    - rube
