---
id: bwc-skill-one-drive-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/one-drive-automation/SKILL.md
name: one-drive-automation
description: >-
  Automate OneDrive file management, search, uploads, downloads, sharing,
  permissions, and folder operations via Rube MCP (Composio). Always search
