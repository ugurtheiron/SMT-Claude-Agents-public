---
id: bwc-skill-cal-com-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/cal-com-automation/SKILL.md
name: cal-com-automation
description: >-
  Automate Cal.com tasks via Rube MCP (Composio): manage bookings, check
  availability, configure webhooks, and handle teams. Always search tools first
  for current schemas.
requires:
  mcp:
    - rube
