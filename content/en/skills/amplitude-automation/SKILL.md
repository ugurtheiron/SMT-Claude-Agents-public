---
id: bwc-skill-amplitude-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/amplitude-automation/SKILL.md
name: amplitude-automation
description: >-
  Automate Amplitude tasks via Rube MCP (Composio): events, user activity,
