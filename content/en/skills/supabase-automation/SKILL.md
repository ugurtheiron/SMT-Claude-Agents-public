---
id: bwc-skill-supabase-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/supabase-automation/SKILL.md
name: supabase-automation
description: >-
  Automate Supabase database queries, table management, project administration,
  storage, edge functions, and SQL execution via Rube MCP (Composio). Always
