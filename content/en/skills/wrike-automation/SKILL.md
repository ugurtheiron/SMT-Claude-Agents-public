---
id: bwc-skill-wrike-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/wrike-automation/SKILL.md
name: wrike-automation
description: >-
  Automate Wrike project management via Rube MCP (Composio): create
