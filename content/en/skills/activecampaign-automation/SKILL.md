---
id: bwc-skill-activecampaign-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/activecampaign-automation/SKILL.md
name: activecampaign-automation
description: >-
  Automate ActiveCampaign tasks via Rube MCP (Composio): manage contacts, tags,
  list subscriptions, automation enrollment, and tasks. Always search tools
