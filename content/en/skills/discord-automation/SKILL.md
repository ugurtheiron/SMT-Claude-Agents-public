---
id: bwc-skill-discord-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/discord-automation/SKILL.md
name: discord-automation
description: >-
  Automate Discord tasks via Rube MCP (Composio): messages, channels, roles,
  webhooks, reactions. Always search tools first for current schemas.
requires:
  mcp:
    - rube
