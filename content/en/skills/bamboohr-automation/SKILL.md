---
id: bwc-skill-bamboohr-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/bamboohr-automation/SKILL.md
name: bamboohr-automation
description: >-
  Automate BambooHR tasks via Rube MCP (Composio): employees, time-off,
  benefits, dependents, employee updates. Always search tools first for current
  schemas.
requires:
  mcp:
    - rube
