---
id: bwc-skill-close-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/close-automation/SKILL.md
name: close-automation
description: >-
  Automate Close CRM tasks via Rube MCP (Composio): create leads, manage
  calls/SMS, handle tasks, and track notes. Always search tools first for
  current schemas.
requires:
  mcp:
    - rube
