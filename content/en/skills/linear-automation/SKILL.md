---
id: bwc-skill-linear-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/linear-automation/SKILL.md
name: linear-automation
description: >-
  Automate Linear tasks via Rube MCP (Composio): issues, projects, cycles,
