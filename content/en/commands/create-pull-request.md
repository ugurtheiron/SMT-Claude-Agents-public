---
id: bwc-command-create-pull-request
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/create-pull-request.md
description: >-
  Guide for creating pull requests using GitHub CLI with proper templates and
  conventions
