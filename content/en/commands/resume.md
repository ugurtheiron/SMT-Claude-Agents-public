---
id: bwc-command-resume
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/resume.md
description: >-
  Resume work on existing task orchestrations after session loss or context
  switch.
