---
id: bwc-command-remove
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/remove.md
description: >-
  Safely remove a task from the orchestration system, updating all references
  and dependencies.
