---
id: bwc-command-add-to-changelog
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/add-to-changelog.md
description: >-
  Add a new entry to the project's CHANGELOG.md file following Keep a Changelog
  format
