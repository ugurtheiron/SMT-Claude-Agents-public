---
id: bwc-command-commit-fast
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/commit-fast.md
description: >-
  Automatically create and execute a git commit using the first suggested commit
  message
