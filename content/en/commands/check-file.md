---
id: bwc-command-check-file
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/check-file.md
description: >-
  Perform comprehensive analysis of $ARGUMENTS to identify code quality issues,
