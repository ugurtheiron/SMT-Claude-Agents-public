---
id: bwc-command-add-property-based-testing
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/add-property-based-testing.md
