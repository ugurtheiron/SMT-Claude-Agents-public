---
id: bwc-command-update-docs
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/update-docs.md
description: >-
  Update implementation documentation including specs, status, and best
  practices
