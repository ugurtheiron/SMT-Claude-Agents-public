...
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/docs.md
description: >-
  Update or generate YAML documentation for SQL models with proper descriptions
  and tests
