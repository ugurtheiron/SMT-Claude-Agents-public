---
id: bwc-hook-smart-commit
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-hooks/hooks/smart-commit.md
name: smart-commit
description: >-
  Intelligent git commit creation with automatic message generation and
  validation
category: git
event: PostToolUse
matcher: Edit
