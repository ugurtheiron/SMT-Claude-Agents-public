---
id: bwc-command-svelte-debug
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/svelte-debug.md
description: >-
  Help debug Svelte and SvelteKit issues by analyzing error messages, stack
