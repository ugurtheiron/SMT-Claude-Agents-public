---
id: bwc-command-svelte-test
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/svelte-test.md
description: >-
  Create comprehensive tests for Svelte components and SvelteKit routes,
