---
id: bwc-command-status
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/status.md
description: >-
  Check the current status of tasks in the orchestration system with various
