...
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/sync.md
description: >-
  Synchronize task status with git commits, ensuring consistency between version
