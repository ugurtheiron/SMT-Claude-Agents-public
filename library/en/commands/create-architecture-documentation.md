---
id: bwc-command-create-architecture-documentation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/create-architecture-documentation.md
