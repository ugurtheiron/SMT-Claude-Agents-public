...
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/todo.md
description: >-
  Manage project todos in a todos.md file with add, complete, remove, and list
  operations
