---
id: bwc-command-decision-tree-explorer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-commands/commands/decision-tree-explorer.md
description: >-
  Explore decision branches with probability weighting, expected value analysis,
  and scenario-based optimization.
