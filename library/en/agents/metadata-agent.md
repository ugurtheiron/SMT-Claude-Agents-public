---
id: bwc-agent-metadata-agent
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/metadata-agent.md
name: metadata-agent
category: specialized-domains
description: >-
  Handles frontmatter standardization and metadata addition across vault files.
  Ensures consistent metadata structure, generates tags, and maintains
