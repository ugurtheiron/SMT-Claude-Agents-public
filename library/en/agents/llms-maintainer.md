---
id: bwc-agent-llms-maintainer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/llms-maintainer.md
name: llms-maintainer
category: data-ai
description: >-
  Generates and maintains llms.txt roadmap files for AI crawler navigation.
  Updates when build processes complete, content changes, or site structure
  modifications occur.
---
