---
id: bwc-agent-hackathon-ai-strategist
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/hackathon-ai-strategist.md
name: hackathon-ai-strategist
category: data-ai
description: >-
  Expert guidance on hackathon strategy, AI solution ideation, and project
  evaluation. Provides judge-perspective feedback, brainstorms winning AI
  concepts, and assesses project feasibility for tight timeframes.
---
