---
id: bwc-agent-research-coordinator
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/research-coordinator.md
name: research-coordinator
description: >-
  Strategically plan and coordinate complex research tasks across multiple
  specialists. Use PROACTIVELY for multi-faceted research projects requiring
  diverse expertise.
