---
id: bwc-agent-query-clarifier
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/query-clarifier.md
name: query-clarifier
description: >-
  Analyze research queries for clarity and determine if clarification is needed.
  Use PROACTIVELY at the beginning of research workflows to ensure queries are
