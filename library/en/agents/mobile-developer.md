---
id: bwc-agent-mobile-developer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/mobile-developer.md
name: mobile-developer
description: >-
  Develop React Native or Flutter apps with native integrations. Handles offline
  sync, push notifications, and app store deployments. Use PROACTIVELY for
