---
id: bwc-agent-deployment-engineer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/deployment-engineer.md
name: deployment-engineer
description: >-
  Configure CI/CD pipelines, Docker containers, and cloud deployments. Handles
  GitHub Actions, Kubernetes, and infrastructure automation. Use PROACTIVELY
