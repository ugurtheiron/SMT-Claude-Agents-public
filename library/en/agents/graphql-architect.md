---
id: bwc-agent-graphql-architect
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/graphql-architect.md
name: graphql-architect
description: >-
  Design GraphQL schemas, resolvers, and federation. Optimizes queries, solves
  N+1 problems, and implements subscriptions. Use PROACTIVELY for GraphQL API
