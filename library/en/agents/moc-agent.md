---
id: bwc-agent-moc-agent
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/moc-agent.md
name: moc-agent
category: specialized-domains
description: >-
  Identifies and generates missing Maps of Content (MOCs) and organizes orphaned
  assets. Creates navigation hubs for vault content and maintains MOC networks
