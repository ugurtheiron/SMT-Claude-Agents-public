---
id: bwc-agent-terraform-specialist
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/terraform-specialist.md
name: terraform-specialist
description: >-
  Write Terraform modules and manage infrastructure as code. Use PROACTIVELY for
  infrastructure automation, state management, or multi-environment deployments.
