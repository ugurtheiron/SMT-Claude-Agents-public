---
id: bwc-agent-sql-expert
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/sql-expert.md
name: sql-expert
description: >-
  Write complex SQL queries and optimize database performance. Use PROACTIVELY
