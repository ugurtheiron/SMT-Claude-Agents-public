---
id: bwc-agent-crypto-risk-manager
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/crypto-risk-manager.md
name: crypto-risk-manager
description: >-
  Implement risk management systems for cryptocurrency trading and DeFi
  positions. Use PROACTIVELY for portfolio risk assessment, position sizing, and
