---
id: bwc-agent-crypto-analyst
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/crypto-analyst.md
name: crypto-analyst
description: >-
  Perform cryptocurrency market analysis, on-chain analytics, and sentiment
  analysis. Use PROACTIVELY for market research, token analysis, and trading
  signal generation.
