---
id: bwc-agent-architect-review
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/architect-review.md
name: architect-review
category: quality-security
description: >-
  Reviews code changes for architectural consistency and patterns. Use
  PROACTIVELY after any structural changes, new services, or API modifications.
