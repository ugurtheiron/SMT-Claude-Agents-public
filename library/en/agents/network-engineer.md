---
id: bwc-agent-network-engineer
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/network-engineer.md
name: network-engineer
category: infrastructure-operations
description: >-
  Debug network connectivity, configure load balancers, and analyze traffic
  patterns. Handles DNS, SSL/TLS, CDN setup, and network security. Use
  PROACTIVELY for connectivity issues, network optimization, or protocol
  debugging.
---
