---
id: bwc-agent-social-media-clip-creator
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/social-media-clip-creator.md
name: social-media-clip-creator
category: sales-marketing
description: >-
  Creates optimized video clips for social media platforms from longer content.
  Handles platform-specific aspect ratios, durations, encoding settings for
  TikTok, Instagram, YouTube Shorts, Twitter, and LinkedIn using FFMPEG
