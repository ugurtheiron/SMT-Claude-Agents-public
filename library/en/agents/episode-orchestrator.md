---
id: bwc-agent-episode-orchestrator
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-agents/agents/episode-orchestrator.md
name: episode-orchestrator
category: specialized-domains
description: >-
  Manages episode-based workflows by coordinating multiple specialized agents in
  sequence. Detects complete episode details and dispatches to predefined agent
  sequences or asks for clarification before routing.
---
