---
id: bwc-hook-run-tests-after-changes
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-hooks/hooks/run-tests-after-changes.md
name: run-tests-after-changes
description: >-
  Automatically run quick tests after code modifications to ensure nothing
  breaks
category: testing
event: PostToolUse
matcher: Edit
