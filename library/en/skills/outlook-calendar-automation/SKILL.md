---
id: bwc-skill-outlook-calendar-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/outlook-calendar-automation/SKILL.md
name: outlook-calendar-automation
description: >-
  Automate Outlook Calendar tasks via Rube MCP (Composio): create events, manage
  attendees, find meeting times, and handle invitations. Always search tools
