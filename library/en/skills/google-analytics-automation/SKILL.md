---
id: bwc-skill-google-analytics-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/google-analytics-automation/SKILL.md
name: google-analytics-automation
description: >-
  Automate Google Analytics tasks via Rube MCP (Composio): run reports, list
  accounts/properties, funnels, pivots, key events. Always search tools first
  for current schemas.
requires:
  mcp:
    - rube
