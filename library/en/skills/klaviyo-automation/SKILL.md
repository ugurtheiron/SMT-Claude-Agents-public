---
id: bwc-skill-klaviyo-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/klaviyo-automation/SKILL.md
name: klaviyo-automation
description: >-
  Automate Klaviyo tasks via Rube MCP (Composio): manage email/SMS campaigns,
  inspect campaign messages, track tags, and monitor send jobs. Always search
