---
id: bwc-skill-mixpanel-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/mixpanel-automation/SKILL.md
name: mixpanel-automation
description: >-
  Automate Mixpanel tasks via Rube MCP (Composio): events, segmentation,
  funnels, cohorts, user profiles, JQL queries. Always search tools first for
  current schemas.
requires:
  mcp:
    - rube
