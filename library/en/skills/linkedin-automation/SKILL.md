---
id: bwc-skill-linkedin-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/linkedin-automation/SKILL.md
name: linkedin-automation
description: >-
  Automate LinkedIn tasks via Rube MCP (Composio): create posts, manage profile,
  company info, comments, and image uploads. Always search tools first for
  current schemas.
requires:
  mcp:
    - rube
