---
id: bwc-skill-coda-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/coda-automation/SKILL.md
name: coda-automation
description: >-
  Automate Coda tasks via Rube MCP (Composio): manage docs, pages, tables, rows,
  formulas, permissions, and publishing. Always search tools first for current
  schemas.
requires:
  mcp:
    - rube
