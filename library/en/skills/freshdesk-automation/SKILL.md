---
id: bwc-skill-freshdesk-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/freshdesk-automation/SKILL.md
name: freshdesk-automation
description: >-
  Automate Freshdesk helpdesk operations including tickets, contacts, companies,
  notes, and replies via Rube MCP (Composio). Always search tools first for
  current schemas.
requires:
  mcp:
    - rube
