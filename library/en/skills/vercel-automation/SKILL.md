---
id: bwc-skill-vercel-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/vercel-automation/SKILL.md
name: vercel-automation
description: >-
  Automate Vercel tasks via Rube MCP (Composio): manage deployments, domains,
  DNS, env vars, projects, and teams. Always search tools first for current
  schemas.
requires:
  mcp:
    - rube
