---
id: bwc-skill-twitter-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/twitter-automation/SKILL.md
name: twitter-automation
description: >-
  Automate Twitter/X tasks via Rube MCP (Composio): posts, search, users,
