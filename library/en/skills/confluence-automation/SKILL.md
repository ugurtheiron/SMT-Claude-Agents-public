---
id: bwc-skill-confluence-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/confluence-automation/SKILL.md
name: confluence-automation
description: >-
  Automate Confluence page creation, content search, space management, labels,
  and hierarchy navigation via Rube MCP (Composio). Always search tools first
  for current schemas.
requires:
  mcp:
    - rube
