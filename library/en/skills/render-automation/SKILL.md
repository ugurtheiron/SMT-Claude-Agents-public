---
id: bwc-skill-render-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/render-automation/SKILL.md
name: render-automation
description: >-
  Automate Render tasks via Rube MCP (Composio): services, deployments,
