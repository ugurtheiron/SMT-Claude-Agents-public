---
id: bwc-skill-make-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/make-automation/SKILL.md
name: make-automation
description: >-
  Automate Make (Integromat) tasks via Rube MCP (Composio): operations, enums,
  language and timezone lookups. Always search tools first for current schemas.
requires:
  mcp:
    - rube
category: automation
