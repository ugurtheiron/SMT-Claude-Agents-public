---
id: bwc-skill-freshservice-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/freshservice-automation/SKILL.md
name: freshservice-automation
description: >-
  Automate Freshservice ITSM tasks via Rube MCP (Composio): create/update
  tickets, bulk operations, service requests, and outbound emails. Always search
