---
id: bwc-skill-dropbox-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/dropbox-automation/SKILL.md
name: dropbox-automation
description: >-
  Automate Dropbox file management, sharing, search, uploads, downloads, and
  folder operations via Rube MCP (Composio). Always search tools first for
  current schemas.
requires:
  mcp:
    - rube
