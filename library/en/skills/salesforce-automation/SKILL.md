---
id: bwc-skill-salesforce-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/salesforce-automation/SKILL.md
name: salesforce-automation
description: >-
  Automate Salesforce tasks via Rube MCP (Composio): leads, contacts, accounts,
  opportunities, SOQL queries. Always search tools first for current schemas.
requires:
  mcp:
    - rube
category: crm
