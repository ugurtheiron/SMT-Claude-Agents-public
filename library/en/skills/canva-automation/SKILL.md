---
id: bwc-skill-canva-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/canva-automation/SKILL.md
name: canva-automation
description: >-
  Automate Canva tasks via Rube MCP (Composio): designs, exports, folders, brand
  templates, autofill. Always search tools first for current schemas.
requires:
  mcp:
    - rube
category: design
