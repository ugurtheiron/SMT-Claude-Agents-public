---
id: bwc-skill-square-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/square-automation/SKILL.md
name: square-automation
description: >-
  Automate Square tasks via Rube MCP (Composio): payments, orders, invoices,
