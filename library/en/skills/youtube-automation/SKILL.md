---
id: bwc-skill-youtube-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/youtube-automation/SKILL.md
name: youtube-automation
description: >-
  Automate YouTube tasks via Rube MCP (Composio): upload videos, manage
  playlists, search content, get analytics, and handle comments. Always search
