---
id: bwc-skill-instagram-automation
source:
  upstream: >-
    https://github.com/davepoon/buildwithclaude/blob/main/plugins/all-skills/skills/instagram-automation/SKILL.md
name: instagram-automation
description: >-
  Automate Instagram tasks via Rube MCP (Composio): create posts, carousels,
  manage media, get insights, and publishing limits. Always search tools first
  for current schemas.
requires:
  mcp:
    - rube
